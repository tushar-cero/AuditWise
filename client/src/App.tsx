...
export const App: FC = () => {
  ...
  const handleTransaction = async (e: any) => {
    ...
    try {
      const response = await axios.post('http://127.0.0.1:8000/api/transactions/create/', { text: transactionFormData }, {
        headers: {
  ...
  return (
    <>
      ...
      <div>
        ...
        <input name="transaction" type="text" value={transactionFormData} onChange={(e)=>setTransactionFormData(e.target.value)} />
